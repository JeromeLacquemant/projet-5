    ...
    <div class="container">
        <div class="nav-wrapper">
            ...
            <ul class="right hide-on-med-and-down">
                <li class="<?php echo ($page=="home")?"active" : ""; ?>"><a href="/articles-a-la-une">A la une</a></li>
                <li class="<?php echo ($page=="blog")?"active" : ""; ?>"><a href="/ensemble-des-articles">Ensemble des articles</a></li>
